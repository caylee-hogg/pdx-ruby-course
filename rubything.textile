...
* Rails is a framework built on Ruby
...
% say something about irb is an interpreter
...
% make stuff on arrow keys more explicit
...
% intermmediate slides got deleted
...
% add something about showing the whole hash
...
% wording of templates, descriptions
...
% do bc.. to make it formatted more better
% break this out into a series of pieces of defining more and more
% pieces. We can explain the whole thing piecemeal and then end
% with modifying incremement to take an argument and add n instead of 1
...
% add new methods to your counter class!
...
% flip this slide and introduce blocks by example first then explain what
...
% different block iterator than the previous things, something more complicated
...
% LOSE THIS IN FAVOR OF CASE OR SOMETHING MORE USEFUL
...
% Need to add "what is a database" description

h1. At The Console

% say ^C the Rails server not just close down
...
% show finding and editing before creating
% show how to do things right without modifying id fields
...
% NOTE - have example output for the exercises, more guidance for how to get
...
% Need to explain has_many and all that jazz sometime before then
