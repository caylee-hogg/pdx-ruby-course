...
h1. Programming & Web Development
reasons why knowing this is important - slide might be optional given
the fact that this is a less noob group

h1. Introduction To Ruby
(what not to write: Ruby is a dynamically typed language!)

h1. Why Ruby?
Insert reasons to learn Ruby here, e.g.
* Widespread
* Easy to learn
* Easy to deploy
* Rails
