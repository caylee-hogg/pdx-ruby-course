...
% TODO do bc.. to make it formatted more better
% TODO break this out into a series of pieces of defining more and more
...
% TODO add new methods to your counter class!
...
% TODO flip this slide and introduce blocks by example first then explain what
...
% TODO Need to add "what is a database" description

h1. At The Console

% TODO say ^C the Rails server not just close down
...
% TODO show finding and editing before creating
